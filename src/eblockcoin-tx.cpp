...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("eBlockCoin Core eblockcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  eblockcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eblockcoin transaction") + "\n" +
                               "  eblockcoin-tx [options] -create [commands]   " + _("Create hex-encoded eblockcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded eblockcoin transaction
