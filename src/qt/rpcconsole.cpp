                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEBCRPathCustom = GetArg("-zebcrbackuppath", "");
    ...
    if(!strzEBCRPathCustom.empty()) {
        ui->wallet_customzebcrbackuppath->setText(QString::fromStdString(strzEBCRPathCustom));
        ui->wallet_customzebcrbackuppath_label->setVisible(true);
        ui->wallet_customzebcrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEBCRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the eBlockCoin RPC console.") + "<br>" +
