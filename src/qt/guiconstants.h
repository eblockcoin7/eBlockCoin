...
/* eBlockCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "eBlockCoin"
#define QAPP_ORG_DOMAIN "eblockcoin.org"
#define QAPP_APP_NAME_DEFAULT "eBlockCoin-Qt"
#define QAPP_APP_NAME_TESTNET "eBlockCoin-Qt-testnet"
