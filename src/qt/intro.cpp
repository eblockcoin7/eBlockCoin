...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("eBlockCoin Core"),
     ...
     * override -datadir in the eblockcoin.conf file in the default data directory
     * (to be consistent with eblockcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
