...
/** Utility functions used by the eBlockCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render eBlockCoin addresses in monospace font
...
// Parse "eblockcoin:" URI into recipient object, return true on successful parsing
