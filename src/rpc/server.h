...
/**
 * eBlockCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzebcrseed(const UniValue& params, bool fHelp);
extern UniValue getzebcrseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzebcr(const UniValue& params, bool fHelp);
extern UniValue dzebcrstate(const UniValue& params, bool fHelp);
