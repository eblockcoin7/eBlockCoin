...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop eBlockCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "eBlockCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* eBlockCoin features */
        {"eblockcoin", "masternode", &masternode, true, true, false},
        {"eblockcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"eblockcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"eblockcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"eblockcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"eblockcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"eblockcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"eblockcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"eblockcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"eblockcoin", "startmasternode", &startmasternode, true, true, false},
        {"eblockcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"eblockcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"eblockcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"eblockcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"eblockcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"eblockcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"eblockcoin", "mnbudget", &mnbudget, true, true, false},
        {"eblockcoin", "preparebudget", &preparebudget, true, true, false},
        {"eblockcoin", "submitbudget", &submitbudget, true, true, false},
        {"eblockcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"eblockcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"eblockcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"eblockcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"eblockcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"eblockcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"eblockcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"eblockcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"eblockcoin", "mnsync", &mnsync, true, true, false},
        {"eblockcoin", "spork", &spork, true, true, false},
        {"eblockcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzebcrseed", &getzebcrseed, false, false, true},
        {"zerocoin", "setzebcrseed", &setzebcrseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzebcr", &searchdzebcr, false, false, true},
        {"zerocoin", "dzebcrstate", &dzebcrstate, false, false, true}
...
{
    return "> eblockcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11117/\n";
}
