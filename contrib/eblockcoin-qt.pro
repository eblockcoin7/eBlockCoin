...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/eblockcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/eblockcoin-cli.cpp \
           src/eblockcoin-tx.cpp \
           src/eblockcoin.cpp \
           src/db.cpp \
           ...
           src/qt/eblockcoin.cpp \
           src/qt/eblockcoinstrings.cpp \
...
RESOURCES += src/qt/eblockcoin.qrc src/qt/eblockcoin_locale.qrc

TRANSLATIONS += src/qt/locale/eblockcoin_bg.ts \
                src/qt/locale/eblockcoin_de.ts \
                src/qt/locale/eblockcoin_en.ts \
                src/qt/locale/eblockcoin_es.ts \
                src/qt/locale/eblockcoin_fi.ts \
                src/qt/locale/eblockcoin_fr.ts \
                src/qt/locale/eblockcoin_it.ts \
                src/qt/locale/eblockcoin_ja.ts \
                src/qt/locale/eblockcoin_pl.ts \
                src/qt/locale/eblockcoin_pt.ts \
                src/qt/locale/eblockcoin_ru.ts \
                src/qt/locale/eblockcoin_sk.ts \
                src/qt/locale/eblockcoin_sv.ts \
                src/qt/locale/eblockcoin_vi.ts \
                src/qt/locale/eblockcoin_zh_CN.ts \
                src/qt/locale/eblockcoin_zh_TW.ts
