...
#   c) node1 mines 32 blocks, so now node 0 has 60001ebcr, node 1 has 4250ebcr, node2 has none.
#   d) node0 sends 601 ebcr to node2, in two transactions (301 ebcr, then 300 ebcr).
