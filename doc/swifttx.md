...
This mechanism has been integrated into Bitcore-Node-eBlockCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/eBlockCoin-Project/insight-api-eblockcoin#web-socket-api](https://github.com/eBlockCoin-Project/insight-api-eblockcoin#web-socket-api) 
* API: [https://github.com/eBlockCoin-Project/insight-api-eblockcoin#swifttx-transactions](https://github.com/eBlockCoin-Project/insight-api-eblockcoin#swifttx-transactions) 
...
By default, the eBlockCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the eBlockCoin Core daemon:
