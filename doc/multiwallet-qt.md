...
In order to support loading of multiple wallets in eblockcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eblockcoin.cpp.
...
Changes to eblockcoin.cpp
----------------------
eblockcoin.cpp is the entry point into eblockcoin-qt, and as such, will require some minor modifications to provide hooks for
