Contributing to eBlockCoin Core
============================

The eBlockCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the eBlockCoin Core project, and is not to be
confused with overall eBlockCoin Network Protocol consensus changes.

Whether a pull request is merged into eBlockCoin Core rests with the project merge
...
Patches that change eBlockCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the eBlockCoin consensus, it must have been
...
The project leader is the release manager for each eBlockCoin Core release.
